...
import network_discovery, network_metrics
...
#        self.monitor_thread = hub.spawn(self._monitor)
    ...
    def _packet_in_handler(self, ev):
        ...
        self.delay_detector.get_path_metrics([1,2,3])
